...
var name="Dharnumaya";
let age=25;
const city="vishakapatnam";
const college="gayathri vidya parishad college";
//Print all values
...
console.log("Your name is: Dhanumjaya");
document.writeln("Hello"+" Dhanumjaya"+" Welcome to my Page.");
...
let employee={
    ...
    isWorking2: true,
    qualification2:["MBA","Javascript Certification"]
};
//Print:
//Employee name
...
//Grade: B
//Voting: Eligible
let name7="Dhanumjaya";
let age8=25;
let city7="Vishakapatnam";
